      ...
      return (
        <>
          <div className="open-chat">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-chat-text-fill" viewBox="0 0 16 16">
          ...
          <div className="chat-container">
            ...
            <div className="chat-log">
              ...
              <div className="chat-message chat-message--self">
                <div className="chat-message-inner">Sure can boss!</div>
              </div>
              <div className="chat-message chat-message--self">
